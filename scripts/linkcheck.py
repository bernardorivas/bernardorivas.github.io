...
This walks *all* href/src attributes across every exported page -- content
links, `/_next/*` bundles, preloads, stylesheets -- so a dangling asset or a
broken clean-URL route is caught. External (http/mailto/tel/data), protocol-relative and pure in-page
