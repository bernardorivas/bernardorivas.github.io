...
// a Lorenz trajectory and the degree-one persistence diagram of its windowed
// points. The persistence pairs are precomputed in src/data/lorenz-ph.json.

import { useEffect, useRef } from "react";
import { softwareCopy } from "@/data/copy";
import data from "@/data/lorenz-ph.json";

// Projection window for the (x, z) plane.
const X_MIN = -21;
const X_MAX = 21;
const Z_MIN = 0;
const Z_MAX = 52;
